...
intLumi = (
    -5.0e06
)  # in pb-1. If negative, no scaling is applied, just for display on the plot
ana_tex = "e^{+}e^{-} #rightarrow ZH #rightarrow #mu^{+}#mu^{-} b b"
delphesVersion = "3.4.2"
energy = 240.0
collider = "FCC-ee"
inputDir = "outputs/FCCee/higgs/mH-recoil/mumu/histmaker_flavor"
formats = ["png", "pdf"]
outdir = "outputs/FCCee/higgs/mH-recoil/mumu/plots_flavor/"
plotStatUnc = True
